...
namespace Azure.ScannerEUI.ViewModel
{
    ...
    {        
        ...
        bool? _TopCoverLock = null;
        bool? _TopMagneticState = null;
        bool? _OpticalModulePowerStatus = null;
        ...
        public bool? TopCoverLock
        {
            ...
            set
            {
                if (_TopCoverLock != value)
                {
                    ...
                    {
                        Workspace.This.TopCoverLockColor = true;
                    }
                    else
                    {
                        Workspace.This.TopCoverLockColor = false;
                    }
                }
            }
        }
        public bool? TopMagneticState
        {
            ...
            set
            {
                if (_TopMagneticState != value)
                {
                    ...
                    {
                        Workspace.This.TopMagneticStateColor = true;
                    }
                    else
                    {
                        Workspace.This.TopMagneticStateColor = false;
                    }
                }
            }
        }
